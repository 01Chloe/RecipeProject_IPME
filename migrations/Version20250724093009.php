 ...
 */
final class Version20250724093009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD id INT AUTO_INCREMENT NOT NULL, ADD quantity VARCHAR(255) DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient DROP id, DROP quantity');
